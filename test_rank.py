...
def main(params):
    ...
    mr, mrr, hit10, hit3, hit1 = evaluate(model, graph_dataset, 'test', 
                                          params.query_triplets, params.limited_candidate)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", "-d", type=str, default="FB-U50",
                        help="Path to dataset")
    parser.add_argument("--disable_cuda", action='store_true',
                        help="Whether disable the gpu(s)")
    parser.add_argument("--gpu", type=int, default=0,
                        help="Which GPU to use?")
    parser.add_argument("--query_triplets", "-t", type=str, default="all",
                        help="Which triplets to test")
